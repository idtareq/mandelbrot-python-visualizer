...
class MandelbrotVisualizer:
    def __init__(
        ...
        self.calculate_mandelbrot_fn = calculate_mandelbrot_fn
...
def main():
    viz = MandelbrotVisualizer(
        ...
        calculate_mandelbrot_fn=calculate_mandelbrot.calculate_mandelbrot,
